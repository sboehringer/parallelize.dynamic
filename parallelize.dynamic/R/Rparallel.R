...
#' @export parallelize parallelize_call parallelize_initialize parallelize_declare parallelize_setEnable parallelize_internal tempcodefile readFile parallelize_lookup Lapply_getConfig Lapply_setConfig Lapply_setConfigValue
...
LapplyRNGseedCapsuleClass = setRefClass('LapplyRNGseedCapsule',
	...
	#
	store = function() {
		seed <<- rget('.Random.seed', integer(0), envir = .GlobalEnv);
		type <<- RNGkind();
		NULL
	},
	restore = function() {
